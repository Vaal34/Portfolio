...
function About() {
  ...
  return (
    <div className="flex flex-col lg:flex-row size-full bg-primary shadow-custom">
      ...
      <div className="flex w-full lg:w-2/3 flex-col justify-between p-4 lg:pb-9 lg:pr-9 lg:pt-9 lg:pl-0">
        <div className="h-auto lg:h-[10%] mb-4 lg:mb-0">
          <nav className="relative w-full bg-background">
            <ul className="flex flex-wrap md:flex-row lg:flex-nowrap items-center justify-evenly p-2 uppercase text-secondary">
                ...
                >
                  {tab === "étude & formations" ? (
                    <>
                      ...
                      <span className="hidden sm:inline">Études & Formations</span>
                    </>
                  ) : (
                    tab
                  )}
