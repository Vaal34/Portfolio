  ...
  return (
    <>
      <MagicCard
        ...
        gradientOpacity={0.1}
        className="flex h-3/4 w-4/5 justify-center bg-background shadow-lg md:w-2/3"
      >
        <form
        ...
        >
          <div className="relative cursor-pointer before:absolute before:bottom-0 before:left-0 before:h-full before:w-full before:origin-bottom before:scale-y-[0.20] before:bg-secondary before:transition-transform before:duration-500 before:ease-in-out hover:before:scale-y-100">
            <h1 className="relative text-3xl font-thin italic text-primary md:text-6xl">
          ...
          {!success ? (
            <>
              ...
              <div className="flex flex-col gap-2 sm:flex-row">
                <button
                  type="submit"
                  className="flex w-full cursor-pointer items-center justify-between bg-primary px-3 py-2 font-mono text-white shadow-xl duration-500 hover:scale-105 hover:bg-secondary"
                >
                  ...
                  {loading ? (
                    ...
                    >
                      ...
                      <g id="SVGRepo_iconCarrier">
                        <g fill="#3b25e9" fillRule="evenodd" clipRule="evenodd">
                          <path
